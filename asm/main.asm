...
// Open the ROM file
.open "cv64.z64", "cv64.mod.z64", 0

// Include cv64.asm to tell armips' linker where to find the game's function(s)
.include "asm/cv64.asm" 
...
// Hook (i.e. insert a call to) our "mod_play_any_sound()" function inside the game loop, at 0x80015390
.org 0x80015390
